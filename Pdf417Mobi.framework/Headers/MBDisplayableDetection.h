 ...
 */
- (instancetype)initWithDetectionStatus:(MBBDetectionStatus)status NS_DESIGNATED_INITIALIZER;
 ...
 */
@property (nonatomic, assign, readonly) MBBDetectionStatus detectionStatus;
