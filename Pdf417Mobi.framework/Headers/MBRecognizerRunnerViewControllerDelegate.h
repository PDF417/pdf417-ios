 ...
 */
- (void)recognizerRunnerViewControllerUnauthorizedCamera:(nonnull UIViewController<MBBRecognizerRunnerViewController> *)recognizerRunnerViewController;
 ...
 */
- (void)recognizerRunnerViewController:(nonnull UIViewController<MBBRecognizerRunnerViewController> *)recognizerRunnerViewController didFindError:(NSError *)error;
 ...
 */
- (void)recognizerRunnerViewControllerDidClose:(nonnull UIViewController<MBBRecognizerRunnerViewController> *)recognizerRunnerViewController;
 ...
 */
- (void)recognizerRunnerViewControllerWillPresentHelp:(nonnull UIViewController<MBBRecognizerRunnerViewController> *)recognizerRunnerViewController;
 ...
 *  @param recognizerRunnerViewController recognizerRunnerViewController Recognizer runner view controller responsible for scanning
 */
- (void)recognizerRunnerViewControllerDidResumeScanning:(nonnull UIViewController<MBBRecognizerRunnerViewController> *)recognizerRunnerViewController;
 ...
 *  @param recognizerRunnerViewController recognizerRunnerViewController Recognizer runner view controller responsible for scanning
 */
- (void)recognizerRunnerViewControllerDidStopScanning:(nonnull UIViewController<MBBRecognizerRunnerViewController> *)recognizerRunnerViewController;
 ...
 */
- (void)recognizerRunnerViewController:(nonnull UIViewController<MBBRecognizerRunnerViewController> *)recognizerRunnerViewController willSetTorch:(BOOL)isTorchOn;
