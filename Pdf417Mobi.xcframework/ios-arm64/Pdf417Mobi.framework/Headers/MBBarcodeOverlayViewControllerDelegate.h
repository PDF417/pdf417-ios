 ...
 * - each scanning result belongs to a common MBBRecognizerResult type
 ...
 *
 */
- (void)barcodeOverlayViewControllerDidFinishScanning:(nonnull MBBBarcodeOverlayViewController *)barcodeOverlayViewController state:(MBBRecognizerResultState)state;
 ...
 */
- (void)barcodeOverlayViewControllerDidTapClose:(nonnull MBBBarcodeOverlayViewController *)barcodeOverlayViewController;
