...
@property (nonatomic, weak, nullable) id<MBBDebugRecognizerRunnerDelegate> debugRecognizerRunnerDelegate;
@property (nonatomic, weak, nullable) id<MBBDetectionRecognizerRunnerDelegate> detectionRecognizerRunnerDelegate;
