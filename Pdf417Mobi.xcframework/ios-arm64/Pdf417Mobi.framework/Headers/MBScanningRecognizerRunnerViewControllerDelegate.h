...
- (void)recognizerRunnerViewControllerDidFinishScanning:(nonnull UIViewController<MBBRecognizerRunnerViewController> *)recognizerRunnerViewController state:(MBBRecognizerResultState)state;
