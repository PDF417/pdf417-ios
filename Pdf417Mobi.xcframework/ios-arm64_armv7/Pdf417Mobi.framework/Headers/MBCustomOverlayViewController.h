...
@property (nonatomic, readonly, strong) MBBRecognizerCollection *recognizerCollection;
@property (nonatomic, readonly, strong) MBBCameraSettings *cameraSettings;
@property (nonatomic, strong) MBBRecognizerRunnerViewControllerMetadataDelegates *metadataDelegates;
@property (nonatomic, weak) id<MBBScanningRecognizerRunnerViewControllerDelegate> scanningRecognizerRunnerViewControllerDelegate;
@property (nonatomic, weak) id<MBBRecognizerRunnerViewControllerDelegate> recognizerRunnerViewControllerDelegate;

/**
 * Convenience initializer used for use cases when overlay view controller is instantiated from storyboard.
 * It creates default MBBCameraSettings and empty MBBRecognizerCollection. To add recognizers after this
 * initializer is used, please use reconfigureRecognizers:.
 */
- (instancetype)init;

- (instancetype)initWithRecognizerCollection:(MBBRecognizerCollection *)recognizerCollection cameraSettings:(MBBCameraSettings *)cameraSettings NS_DESIGNATED_INITIALIZER;
