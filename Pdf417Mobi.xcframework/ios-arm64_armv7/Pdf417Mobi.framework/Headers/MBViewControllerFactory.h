 ...
 * The only requirement for the overlay view is that it's a subclass of MBBOverlayViewController
 *
 ...
 */
+ (nullable UIViewController<MBBRecognizerRunnerViewController> *)recognizerRunnerViewControllerWithOverlayViewController:(nonnull MBBOverlayViewController *)overlayViewController NS_SWIFT_NAME(recognizerRunnerViewController(withOverlayViewController:));
