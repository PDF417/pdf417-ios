...
static inline NSString * MBB_LOCALIZED(NSString *key) {
    ...
    NSString *localizedString = MBB_LOCALIZED_FOR_LANGUAGE(key, [MBBMicroblinkApp sharedInstance].language);
    
#ifndef DNDEBUG
    return localizedString;
#else
    if ([localizedString isEqualToString:MBB_LOCALIZED_DEFAULT_STRING(key)] && ![MBBMicroblinkApp.sharedInstance.language isEqualToString:@"en"]) {
