...
@class MBBOverlayViewController;
@class MBBImage;

/** Block for returning high resolution MBBImage photo with capture or still output */
typedef void(^MBBCaptureHighResImage)(MBBImage * _Nullable highResImage);
...
/**
 * MBBRecognizerRunnerViewController's shouldAutorotate will return this value.
 *
 * Default: NO.
 *
...
/**
 * MBBRecognizerRunnerViewController's supportedInterfaceOrientations will return this value.
 *
 ...
 * Play scan sound.
 *
 * It uses default scan sound, you can change it by setting your own soundFilePath in MBBOverlaySettings.
 */
 ...
 */
- (void)captureHighResImage:(MBBCaptureHighResImage)highResoulutionImageCaptured;
