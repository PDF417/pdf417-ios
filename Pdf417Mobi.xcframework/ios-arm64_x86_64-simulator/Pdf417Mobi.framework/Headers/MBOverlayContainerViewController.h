...
/**
 ...
 Those are events specified by MBBOverlayViewControllerDelegate protocol.
 */
 ...
 */
- (void)overlayViewControllerWillCloseCamera:(MBBOverlayViewController *)overlayViewController;
 ...
 */
- (BOOL)overlayViewControllerShouldDisplayTorch:(MBBOverlayViewController *)overlayViewController;
 ...
 */
- (BOOL)overlayViewController:(MBBOverlayViewController *)overlayViewController willSetTorch:(BOOL)isTorchOn;

/**
 * If help mechanism is implemented using MBBScanDelegate's scanningViewControllerWillPresentHelp method,
